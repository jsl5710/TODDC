...
from toddc.runners.factory import build_client, check_spec

_SPEC_GPT = {"adapter": "toddc.runners.gateway:GatewayClient",
             "model_id": "openai/gpt-4o-mini", "api_key_env": "GATEWAY_KEY"}
_SPEC_CLAUDE = {"adapter": "toddc.runners.gateway:GatewayClient",
