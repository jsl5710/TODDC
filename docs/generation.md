...
PYTHONPATH=src python -m toddc.cli generate --dry-run          # expect all OK
PYTHONPATH=src python -m toddc.cli generate --live --workers 4
```
...
(`toddc.runners.gateway:GatewayClient`) posts to
